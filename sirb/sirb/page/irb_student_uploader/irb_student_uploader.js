frappe.pages['irb-student-uploader'].on_page_load = function(wrapper) {
    const page = frappe.ui.make_app_page({
        parent: wrapper,
        title: 'Upload IRB Student File',
        single_column: true
    });
    ...
    const container = $(`
        <div class="upload-intro" style="max-width: 600px; margin: 40px auto 20px;">
            <p>Select an IRB unit and upload a CSV file.</p>
        </div>
    ...
    // Fixed: Selector changed to find the .progress div, not a <progress> tag
